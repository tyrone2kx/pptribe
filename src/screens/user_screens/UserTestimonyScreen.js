...
const UserTestimonyScreen = (props) => {
    ...
    const addTestimony = () => {
        api.post('add_testimony', { title, description }).then(response => {
            ...
            >
                ...
                <ScrollView alwaysBounceVertical style={{ minHeight: height, backgroundColor: colors.primaryBackground, }}>
                    ...
                    <View style={{ width: '90%', alignSelf: 'center', marginBottom: 30, marginTop: 20 }}>
                        <TouchableOpacity activeOpacity={0.5} style={{ ...styles.addTestimonyBtn, backgroundColor: openForm ? colors.red : colors.blue, }} onPress={() => setOpenForm(!openForm)}>
                            <Text style={{ color: '#FFF' }}>{openForm ? 'CANCEL' : 'SUBMIT A TESTIMONY'}</Text>
                        </TouchableOpacity>
                    </View>
                            ...
                            <View style={{ ...styles.formContainer, backgroundColor: colors.primaryContainerColor }}>
                                ...
                                <View style={{ width: '100%', paddingVertical: 10, justifyContent: 'center' }}>
                                    ...
                                    <TouchableOpacity activeOpacity={0.5} style={{ ...styles.button, backgroundColor: colors.green, }} onPress={() => navigation.navigate('dashboard')}>
                                        <Text style={{ color: '#FFF' }}>SUBMIT TESTIMONY</Text>
                                    </TouchableOpacity>
...
export default connect(mapStateToProps, mapDispatchToProps)(UserTestimonyScreen);
